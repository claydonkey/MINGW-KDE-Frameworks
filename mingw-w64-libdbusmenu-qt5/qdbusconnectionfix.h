//
// Created by anthony on 20/09/2017.
//

#ifndef DBUSMENU_QT_QDBUSCONNECTIONFIX_H
#define DBUSMENU_QT_QDBUSCONNECTIONFIX_H
/****************************************************************************
**
...
public:
    ...
    bool connect(const QString &service, const QString &path, const QString &intface,
    ...
    bool disconnect(const QString &service, const QString &path, const QString &intface,
                    const QString &name, QObject *receiver, const char *slot);
    bool disconnect(const QString &service, const QString &path, const QString &intface,
                    const QString &name, const QString& signature,
                    QObject *receiver, const char *slot);
    ...
    bool registerObject(const QString &path, const QString &intface, QObject *object,
                        RegisterOptions options = ExportAdaptors);
    ...
    QDBusConnectionInterface *intface() const;
...
#endif //DBUSMENU_QT_QDBUSCONNECTIONFIX_H
